...
import type { AssetComplianceResult, AssetDidResult, Authorization, AuthorizationType, CanTransferResult, CappedFee, CddStatus, DidRecords, DidStatus, GranularCanTransferResult, IdentityId, KeyIdentityData, PipId, PortfolioId, ProtocolOp, Signatory, Ticker, VoteCount } from "./polymesh";
declare module '@polkadot/rpc-core/types.jsonrpc' {
    interface RpcInterface {
        asset: {
             ...
             **/
            canTransfer: AugmentedRpc<(sender: AccountId | string | Uint8Array, from_custodian: Option<IdentityId> | null | object | string | Uint8Array, from_portfolio: PortfolioId | {
                did?: any;
                kind?: any;
            } | string | Uint8Array, to_custodian: Option<IdentityId> | null | object | string | Uint8Array, to_portfolio: PortfolioId | {
                did?: any;
                kind?: any;
            } | string | Uint8Array, ticker: Ticker | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, blockHash?: Hash | string | Uint8Array) => Observable<CanTransferResult>>;
            /**
             ...
             **/
            canTransferGranular: AugmentedRpc<(from_custodian: Option<IdentityId> | null | object | string | Uint8Array, from_portfolio: PortfolioId | {
                did?: any;
                kind?: any;
            } | string | Uint8Array, to_custodian: Option<IdentityId> | null | object | string | Uint8Array, to_portfolio: PortfolioId | {
                did?: any;
                kind?: any;
            } | string | Uint8Array, ticker: Ticker | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, blockHash?: Hash | string | Uint8Array) => Observable<GranularCanTransferResult>>;
        };
        author: {
            /**
